...
<body>
  <nav class="navbar navbar-expand-md navbar-light sticky-top" style="">
    <div class="container-fluid">
      <a href="#" class="navbar-brand">
        <img src="../img/logoBode.png" alt="" width="60" height="60">
        <h3 class="d-inline align-middle">Grêmio Estudantil</h3>
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="nav navbar-nav ms-auto w-100 justify-content-end">
          ...
          <li class="nav-item">
            <a href="#apresent" class="nav-link"><i class="fa-solid fa-person-chalkboard"></i> Apresentação</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item" href="cadastroP.php">Cadastre-se</a></li>
            </ul>
          </li>
        </ul>
      </div>
        ...
        <div class="container-xxl py-5">
          <div class="container apresent" id="apresent">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s"
              ...
              <h1 class="fs-2 fw-bold">O que oferecemos?</h1>
              <p class="text-dark fs-4 mb-5">Após o login/cadastro, isso é tudo o que pode ser feito através da nossa plataforma:</p>
            </div>
            <div class="row g-5">
              <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.1s"
                ...
                <div class="d-flex align-items-start card-body">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      <h5 class="card-title"><i class="fa-regular fa-newspaper"></i> Postagens</h5>
                      <p class="card-text">
                        Acompanhe as postagens mais recentes feitas pelo Grêmio Estudantil!
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.1s"
                ...
                <div class="d-flex align-items-start card-body">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      <h5 class="card-title"><i class="fa-solid fa-boxes-stacked"></i> Reservas</h5>
                      <p class="card-text">
                        Através do nosso sistema, é possível reservar seu uniforme do Cefet com apenas alguns cliques!
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp " data-wow-delay="0.1s"
                ...
                <div class="d-flex align-items-start card-body">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      <h5 class="card-title"><i class="fa-solid fa-comments"></i> Feedbacks</h5>
                      <p class="card-text">
                        Envie sua opinião sobre infraestrutura e outros assuntos com nosso sistema de feedbacks!
                      </p>
                    </div>
                  </div>
                </div>
    ...
    <div class="container p-4 ">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          <h5 class="text">Entre no nosso site:</h5>
          <ul class="list-unstyled">
            <li>
              <a href="Login" class="text-dark">Faça seu login</a>
            </li>
            <li>
              <a href="CadastroP" class="text-dark">Faça seu cadastro</a>
            </li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
