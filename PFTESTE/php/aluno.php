                ...
                <div class="d-flex align-items-start card-body">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <a href="postagem.php" class="btn btn-primary acessar">Acessar</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="d-flex align-items-start card-body">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <a href="produtos.php" class="btn btn-primary acessar">Acessar</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="d-flex align-items-start card-body">
                  <div class="card" style="width: 18rem;">
                    <div class="card-body">
                      ...
                      <a href="formfeedback.php" class="btn btn-primary acessar">Acessar</a>
                    </div>
                  </div>
                </div>
              </div>
